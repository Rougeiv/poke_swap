...
# Get the directory of the current script (populate_pokemon_table.py)
current_dir = os.path.dirname(os.path.abspath(__file__))

# Get the parent directory of the current directory (app)
parent_dir = os.path.dirname(current_dir)

# Add the parent directory (poke_swap) to sys.path
sys.path.append(parent_dir)

# create a flask application instance
app = Flask(__name__)

# Now you can import modules from your Flask application
from app import db
db.init_app(app)
...
def populate_pokemon_table():
    # List of original 151 Pokemon with their Pokedex number, name, and shiny status
    pokemon_data = [
    ...
    {"pokedex_num": 29, "name": "Nidoran♀", "shiny": False, "sprite_path": "path_to_nidoran_female_sprite.png"},
    ...
    {"pokedex_num": 32, "name": "Nidoran♂", "shiny": False, "sprite_path": "path_to_nidoran_male_sprite.png"},
    ...
    {"pokedex_num": 83, "name": "Farfetch'd", "shiny": False, "sprite_path": "path_to_farfetchd_sprite.png"},
    ...
    with app.app_context():
        ...
        for pokemon_info in pokemon_data:
            pokemon = Pokemon(
                pokedex_num=pokemon_info["pokedex_num"],
                name=pokemon_info["name"],
                shiny=pokemon_info["shiny"]
            )
